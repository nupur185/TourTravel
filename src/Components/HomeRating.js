...
export default function HomeRating({tourdata}) {

    const topRated=[...tourdata].sort((a, b) => b.ratings - a.ratings).slice(0, 8);
    const stars = [];
    ...
    return (
        ...
        <div>
            <h2 className="text-2xl font-bold">Our Most-Loved Adventures</h2>
            <p>Popular Activities and Day Tours - Our Guests' Top Picks</p>
        </div>
