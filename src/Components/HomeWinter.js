...
export default function HomeWinter() {
    ...
    const shuffledTours = (([...wintertours].sort(() => Math.random() - 0.5)).slice(0,8));   
    ...
    return (
        ...
        <div className="textheading">
            <h2 className="text-2xl font-bold">Winter Specials - Tours and Multi-Day Adventures</h2>
            <p>Northern Lights, Crystal Blue Ice Caves - Tried & Trusted Summer Itineraries.</p>
        </div>
